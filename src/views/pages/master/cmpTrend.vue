      ...
      this.grid.updateConfig({
        ...
        style: {
          ...
          th: {
            ...
            padding: "8px 12px", // Padding untuk ruang pada header
            "font-size": "14px", // Ukuran font header
            "white-space": "nowrap", // Mencegah header membungkus teks
          },
          td: {
            "text-align": "center", // Perataan teks di tengah untuk isi tabel
            padding: "8px 12px", // Padding untuk ruang pada data tabel
