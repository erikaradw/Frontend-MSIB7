              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <CmpInputText
                    ...
                    v-model="todo.area_code"
                    :class="
                      errorField.area_code
                        ? 'form-control input-lg input-error'
                        : 'form-control input-lg'
                    "
                    :disabled="!flagButtonAdd"
                    @input="
                      (val) => (todo.area_code = todo.area_code.toUpperCase())
                    "
                  />
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <CmpInputText
                    ...
                    "
                    @input="
                      (val) => (todo.region_code = todo.region_code.toUpperCase())
                    "
                  />
                </div>
              </div>
...
export default {
  ...
  methods: {
        ...
        if (result.isConfirmed) {
          ...
          try {
            const response = await axios.delete(
              mythis.$root.apiHost + mythis.$root.prefixApi + "M_Areadelete",
              config
            );
            mythis.$root.stopLoading();
    ...
    saveTodo() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          // };
          const config = "";
          var url = mythis.$root.apiHost + mythis.$root.prefixApi + "M_Area";
    ...
    saveTodoBulky() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          const config = "";
          var url =
            mythis.$root.apiHost + mythis.$root.prefixApi + "M_AreaBulky";
    ...
    async getDataExportExcel() {
      ...
      mythis.nama_excelnya = "MASTER_AREA_" + a + ".xlsx";
    ...
    async exportPdf() {
      ...
      try {
        ...
        doc.autoTable({
          theme: "striped",
          head: [["No", "Area Code", "Area Name", "Region Code","Region Name"]],
        ...
        const fileName =
          "Master_Area_Report_" + mythis.formatDate(new Date()) + ".pdf";
        doc.save(fileName);
    ...
    getTable() {
      ...
      this.grid.updateConfig({
        ...
        server: {
          url: this.$root.apiHost + this.$root.prefixApi + "M_Area",
          then: (data) =>
    ...
    deleteTodo(id) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          axios
            .delete(
              mythis.$root.apiHost + mythis.$root.prefixApi + `M_Area/${id}`,
              config
            )
            .then((res) => {
