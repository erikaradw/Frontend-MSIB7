        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="example-nf-email">Branch Code</label>
                  <CmpInputText
                    type="text"
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="example-nf-email">Dist Code</label>
                  <CmpInputText
                    id="inputA"
                    type="text"
                    placeholder="Input Dist Code "
  ...
  <div id="page-content" v-if="isLogin == 1" style="min-height: 850px">
    ...
    <div class="block">
      ...
      <div class="block-title">
        <h2>
          <strong>MENU CABANG{{ $root.judulHalaman }}</strong>
        </h2>
...
export default {
  ...
  methods: {
        ...
        if (result.isConfirmed) {
          ...
          try {
            const response = await axios.delete(
              mythis.$root.apiHost + mythis.$root.prefixApi + "M_Cabangdelete",
              config
            );
            mythis.$root.stopLoading();
    ...
    async getAllDistCode() {
      this.isFetching = true;

      const urlGetDistCode =
        this.$root.apiHost + this.$root.prefixApi + "M_DistCabangAll";
      const { data } = await axios.get(urlGetDistCode);
      console.log(data, "SINI");
      this.dataDistCode = data.data;

      this.isFetching = false;
    },

    onChangeDistCodeHandler() {
      this.todo.dist_code = this.selectedDistCode.dist_code;
    },
    ...
    saveTodo() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          // };
          const config = "";
          var url = mythis.$root.apiHost + mythis.$root.prefixApi + "M_Cabang";
    ...
    saveTodoBulky() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          const config = "";
          var url =
            mythis.$root.apiHost + mythis.$root.prefixApi + "M_CabangBulky";
    ...
    async getDataExportExcel() {
      ...
      mythis.nama_excelnya = "MASTER_CABANG_" + a + ".xlsx";
    ...
    async exportPdf() {
      ...
      try {
        ...
        doc.setFontSize(18);
        doc.text("Master Cabang Report", 14, 22);
        doc.setFontSize(11);
        ...
        const fileName =
          "Master_cabang_Report_" + mythis.formatDate(new Date()) + ".pdf";
        doc.save(fileName);
    ...
    getTable() {
      ...
      this.grid.updateConfig({
        ...
        server: {
          url: this.$root.apiHost + this.$root.prefixApi + "M_Cabang",
          then: (data) =>
    ...
    deleteTodo(id) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          axios
            .delete(
              mythis.$root.apiHost + mythis.$root.prefixApi + `M_Cabang/${id}`,
              config
            )
            .then((res) => {
    ...
    async getData(id) {
      ...
      await axios
        ...
        .then(async (res) => {
          ...
          mythis.todo.nama_cabang = res.data.data.nama_cabang.toUpperCase();
          mythis.todo.branch_code = res.data.data.branch_code.toUpperCase();
          mythis.todo.dist_code = res.data.data.dist_code.toUpperCase();
          mythis.todo.area_code = res.data.data.area_code.toUpperCase();
          mythis.todo.area_name = res.data.data.area_name.toUpperCase();
