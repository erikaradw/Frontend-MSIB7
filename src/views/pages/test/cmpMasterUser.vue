        ...
        <div class="modal-body">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <CmpInputText
                    ...
                    @input="
                      (val) => {
                        todo.nama = todo.nama.toUpperCase();
                      }
                    "
                  />
                </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="example-nf-email">Telepon</label>
                  <CmpInputText
                    type="text"
                    placeholder="telepon"
                    v-model="todo.telp"
                    ...
                    @input="
                      (val) => {
                        todo.telp = todo.telp.toUpperCase();
                      }
                    "
                  />
                </div>
    ...
    async getData(id) {
      ...
      await axios
        ...
        .then(async (res) => {
          ...
          mythis.todo.id = id;
          mythis.todo.nama = res.data.data.nama.toUpperCase();
          mythis.todo.alamat = res.data.data.alamat.toUpperCase();
